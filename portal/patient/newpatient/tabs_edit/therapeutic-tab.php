...
<?php if ($therapeutic['therapSupportList'] == 'employeement') { ?>
    <div class="row" name="employeementDiv" style="display:block"></br>
        ...
        <input type="text" style="width:50%" name="career" value="<?php echo $therapeutic['career'] ?>" class="form-control" disabled></br>
    ...
    <input type = "text" style = "width:50%" name = "work_where" class = "form-control"></br> -->
        ...
        <input type="text" style="width:50%" name="work_position" value="<?php echo $therapeutic['work_position'] ?>" class="form-control" disabled></br>

        <label>Are you satisfied with your current work experience?<span style="color:red"> * </span></label></br>
        <input type="radio" name="work_exp" value="yes" <?php echo ($therapeutic['work_exp'] == 'yes') ?  "checked" : ""; ?> disabled>Yes</br>
        <input type="radio" name="work_exp" value="no" <?php echo ($therapeutic['work_exp'] == 'no') ?  "checked" : ""; ?> disabled>No</br>
        ...
        <select name="how_long" class="form-control" value="<?php echo $therapeutic['how_long'] ?>" style="width:50%">
            <option value="less_1" <?php echo ($therapeutic['how_long'] == 'less_1') ?  "selected" : ""; ?> disabled>Less than 1 year</option>
            <option value="1_3" <?php echo ($therapeutic['how_long'] == '1_3') ?  "selected" : ""; ?> disabled>1 - 3 years</option>
            <option value="3_5" <?php echo ($therapeutic['how_long'] == '3_5') ?  "selected" : ""; ?> disabled>3 - 5 years</option>
            <option value="more_5" <?php echo ($therapeutic['how_long'] == 'more_5') ?  "selected" : ""; ?> disabled>More than 5 years</option>
        </select></br>
    </div>
<?php } ?>
...
<?php if ($therapeutic['therapSupportList'] == 'unemployeement') { ?>
    <div class="row" style="display:block" name="unemployeementDiv">
        ...
        <input type="text" style="width:50%" name="how_long_unemployeed" value="<?php echo $therapeutic['how_long_unemployeed'] ?>" class="form-control" disabled></br>
...
<?php if ($therapeutic['therapSupportList'] == 'pub_assistance') { ?>
    <div class="row" style="display:block" name="publicAssistanceDiv">
        ...
        <input type="text" style="width:50%" name="receiving_assistance" value="<?php echo $therapeutic['receiving_assistance'] ?>" class="form-control" disabled></br>
    </div>
<?php } ?>
...
<?php if ($therapeutic['therapSupportList'] == 'ssi_ssd') { ?>
    <div class="row" style="display:block" name="ssi_ssd_div">
        ...
        <input type="text" style="width:50%" name="ssi_ssd" class="form-control" value="<?php echo $therapeutic['ssi_ssd'] ?>" disabled></br>
    </div>
<?php } ?>
...
<?php if ($therapeutic['therapSupportList'] == 'fam_support') { ?>
    <div class="row" style="display:block" name="family_sup_div">
        ...
        <input type="text" style="width:50%" name="family_support" class="form-control" value="<?php echo $therapeutic['family_support'] ?>" disabled></br>
    </div>
<?php } ?>
...
<?php if ($therapeutic['fam_relationship_list'] == 'Divorced' || $therapeutic['fam_relationship_list'] == 'Widowed') { ?>
    <div class="row" name="DivorcedDiv" style="display:block">
        ...
        <input type="text" name="how_many_married" value="<?php echo $therapeutic['how_many_married'] ?>" class="form-control" style="width:50%" disabled></br>
        <label>What are your ex partner('s) name(s)<span style="color:red"> * </span></label></br>
        <input type="text" name="ex_partner_name" value="<?php echo $therapeutic['ex_partner_name'] ?>" class="form-control" style="width:50%" disabled></br>
    </div>
<?php } ?>
...
<?php if ($therapeutic['fam_relationship_list'] == 'currently_married') { ?>
    <div class="row" name="currentMarriedDiv" style="display:block">
        ...
        <input type="text" name="spouse_name" class="form-control" value="<?php echo $therapeutic['spouse_name'] ?>" style="width:50%" disabled></br>
    </div>
<?php } ?>
...
<?php if ($therapeutic['fam_relationship_list'] == 'single_never_married') { ?>
    <div class="row" name="lastRelationShipDiv" style="display:block">
        ...
        <input type="text" name="last_relationship" value="<?php echo $therapeutic['last_relationship'] ?>" class="form-control" style="width:50%" disabled></br>
    </div>
<?php } ?>
...
<div class="row">
    ...
    <input type="radio" name="fam_support_recovery" value="yes" <?php echo ($therapeutic['fam_support_recovery'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
    <input type="radio" name="fam_support_recovery" value="no" <?php echo ($therapeutic['fam_support_recovery'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
    ...
    <?php if ($therapeutic['fam_support_recovery'] == 'yes') { ?>
        <div class="row" name="fam_support_recovery_div" style="display:block">
            ...
            <input type="radio" name="fam_mem_willing_part" value="yes" <?php echo ($therapeutic['fam_mem_willing_part'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
            <input type="radio" name="fam_mem_willing_part" value="no" <?php echo ($therapeutic['fam_mem_willing_part'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
        </div>
    <?php } ?>
    ...
    <?php if ($therapeutic['fam_mem_willing_part'] == 'yes') { ?>
        <div class="row" name="fam_mem_willing_part_div" style="display:block">
            ...
            <input type="text" name="fam_mem_part_name" class="form-control" style="width:50%" value="<?php echo $therapeutic['fam_mem_part_name'] ?>" disabled></br>
            <label>What is their relationship to you?<span style="color:red"> * </span></label></br>
            <input type="text" name="fam_mem_part_relation" class="form-control" style="width:50%" value="<?php echo $therapeutic['fam_mem_part_relation'] ?>" disabled></br>
            <label>What is their phone number?<span style="color:red"> * </span></label></br>
            <input type="text" name="fam_mem_part_ph" class="form-control" style="width:50%" value="<?php echo $therapeutic['fam_mem_part_ph'] ?>" disabled></br>
        </div>
    <?php } ?>
    ...
    <div class="row">
        ...
        <input type="radio" name="fam_sub_abuse" value="yes" <?php echo ($therapeutic['fam_sub_abuse'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
        <input type="radio" name="fam_sub_abuse" value="no" <?php echo ($therapeutic['fam_sub_abuse'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
    </div>
    ...
    <?php if ($therapeutic['fam_sub_abuse'] == 'yes') { ?>
        <div class="row" style="display:block" name="fam_sub_abuse_div">
            ...
            <textarea name="sub_abuse_explanation" class="form-control" disabled><?php echo $therapeutic['sub_abuse_explanation'] ?></textarea></br>
        </div>
    <?php } ?>
    ...
    <div class="row">
        ...
        <input type="radio" name="primary_care_doc" value="yes" <?php echo ($therapeutic['primary_care_doc'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
        <input type="radio" name="primary_care_doc" value="no" <?php echo ($therapeutic['primary_care_doc'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
    </div>
    ...
    <?php if ($therapeutic['primary_care_doc'] == 'yes') { ?>
        <div class="row" name="primary_care_doc_div" style="display:block">
            ...
            <input type="text" name="pri_doc_name" value="<?php echo $therapeutic['pri_doc_name'] ?>" class="form-control" style="width:50%" disabled></br>
            <label>What is your primary care doctor's phone number?</label></br>
            <input type="text" name="pri_doc_ph" value="<?php echo $therapeutic['pri_doc_ph'] ?>" class="form-control" style="width:50%" disabled></br>
        </div>
    <?php } ?>
    ...
    <div class="row">
        ...
        <input type="radio" name="curr_health" value="good" <?php echo ($therapeutic['curr_health'] == 'good') ?  "checked" : ""; ?> disabled> Good</br>
        <input type="radio" name="curr_health" value="fair" <?php echo ($therapeutic['curr_health'] == 'fair') ?  "checked" : ""; ?> disabled> Fair</br>
        <input type="radio" name="curr_health" value="poor" <?php echo ($therapeutic['curr_health'] == 'poor') ?  "checked" : ""; ?> disabled> Poor</br>
    </div>
    ...
    <?php if ($therapeutic['curr_health'] == 'good') { ?>
        <div class="row" name="curr_health_good_div" style="display:block">
            ...
            <textarea name="surgeries_details" class="form-control" disabled><?php echo $therapeutic['surgeries_details'] ?></textarea></br>
        </div>
    <?php } ?>
    ...
    <?php if ($therapeutic['curr_health'] == 'fair') { ?>
        ...
        <div class="row" name="curr_health_fair_div" style="display:block">
            ...
            <textarea name="med_condition_details" class="form-control" disabled><?php echo $therapeutic['med_condition_details'] ?></textarea></br>
        </div>

        <label>Are you currently prescribed medications from a doctor?<span style="color:red"> * </span></label></br>
        <input type="radio" name="curr_pres_med" value="yes" <?php echo ($therapeutic['curr_pres_med'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
        <input type="radio" name="curr_pres_med" value="no" <?php echo ($therapeutic['curr_pres_med'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
        ...
        <?php if ($therapeutic['curr_pres_med'] == 'yes') { ?>
            <div name="curr_pre_med_div" style="display:block">
                ...
                <textarea name="curr_pre_med_details" class="form-control" disabled><?php echo $therapeutic['curr_pre_med_details'] ?></textarea></br>
            </div>

            <label>Do you take your medication as prescribed?<span style="color:red"> * </span></label></br>
            <input type="radio" name="do_you_take_med_as_pres" value="yes" <?php echo ($therapeutic['do_you_take_med_as_pres'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
            <input type="radio" name="do_you_take_med_as_pres" value="no" <?php echo ($therapeutic['do_you_take_med_as_pres'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
        <?php } ?>
        ...
        <?php if ($therapeutic['do_you_take_med_as_pres'] == 'no') { ?>
            <div name="do_you_take_med_as_pres_div" style="display:block">
                ...
                <textarea name="do_you_take_med_as_pres_details" class="form-control" disabled></textarea></br>
            </div>
        <?php } ?>

        <label>Have you had any recent hospitalization?<span style="color:red"> * </span></label></br>
        <input type="radio" name="recent_hospitalization" value="yes" <?php echo ($therapeutic['recent_hospitalization'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
        <input type="radio" name="recent_hospitalization" value="no" <?php echo ($therapeutic['recent_hospitalization'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
        ...
        <?php if ($therapeutic['recent_hospitalization'] == 'yes') { ?>
            <div class="row" style="display:block" name="recent_hospitalizationDiv">
                ...
                <textarea name="other_health_concern_details" class="form-control" disabled></textarea></br>
            </div>
        <?php } ?>
</div>
<?php } ?>
...
<?php if ($therapeutic['being_referred_for_service'] == 'anger_mgmt') { ?>
    <div class="row" name="being_rf_for_services_anger_mgmt_div" style="display:block">
        ...
        <input type="radio" name="physical_confrontation" value="yes" <?php echo ($therapeutic['physical_confrontation'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
        <input type="radio" name="physical_confrontation" value="no" <?php echo ($therapeutic['physical_confrontation'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
        ...
        <input type="radio" name="physically_hurt" value="yes" <?php echo ($therapeutic['physically_hurt'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
        <input type="radio" name="physically_hurt" value="no" <?php echo ($therapeutic['physically_hurt'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
        ...
        <?php if ($therapeutic['physically_hurt'] == 'yes') { ?>
            <div name="injuriesSustainDiv" style="display:block">
                ...
                <textarea name="injurySusDetail" class="form-control" disabled> <?php echo $therapeutic['physically_hurt'] ?></textarea>
            </div>
        <?php } ?>

        <label>Were you ever arrested for a violent crime?<span style="color:red"> * </span></label><br>
        <input type="radio" name="arrested_violent_crime" value="yes" <?php echo ($therapeutic['physically_hurt'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
        <input type="radio" name="arrested_violent_crime" value="no" <?php echo ($therapeutic['physically_hurt'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
...
<?php if ($therapeutic['being_referred_for_service'] == 'alcohol_drug') { ?>
    <div class="row" style="display:block" name="alcohol_drug_abuse_div">
        ...
        <input type="radio" name="injured_result_drink" value="no" <?php echo ($therapeutic['injured_result_drink'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
        <input type="radio" name="injured_result_drink" value="yes_not_in_past_year" <?php echo ($therapeutic['injured_result_drink'] == 'yes_not_in_past_year') ?  "checked" : ""; ?> disabled> Yes, but not in the past year</br>
        <input type="radio" name="injured_result_drink" value="yes_during_year" <?php echo ($therapeutic['injured_result_drink'] == 'yes_during_year') ?  "checked" : ""; ?> disabled> Yes, during the past year</br>
        ...
        <input type="radio" name="concerned_about_drink" value="no" <?php echo ($therapeutic['concerned_about_drink'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
        <input type="radio" name="concerned_about_drink" value="yes_not_in_past_year" <?php echo ($therapeutic['concerned_about_drink'] == 'yes_not_in_past_year') ?  "checked" : ""; ?> disabled> Yes, but not in the past year</br>
        <input type="radio" name="concerned_about_drink" value="yes_during_year" <?php echo ($therapeutic['concerned_about_drink'] == 'yes_during_year') ?  "checked" : ""; ?> disabled> Yes, during the past year</br>
        ...
        <input type="text" name="first_time_used" value="<?php echo $therapeutic['first_time_used'] ?>" class="form-control" style="width:50%" disabled></br>

        <label>How much did you use at the height of your usage?</label></br>
        <input type="text" name="height_of_usage" value="<?php echo $therapeutic['height_of_usage'] ?>" class="form-control" style="width:50%" disabled></br>

        <label>Have you ever been in alcohol or drug treatment before?</label></br>
        <input type="radio" name="ever_been_in_alcohol" value="yes" <?php echo ($therapeutic['ever_been_in_alcohol'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
        <input type="radio" name="ever_been_in_alcohol" value="no" <?php echo ($therapeutic['ever_been_in_alcohol'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
...
<?php if ($therapeutic['being_referred_for_service'] == 'dwi_dui') { ?>
    <div class="row" style="display:block" name="dwi_dui_div">
        ...
        <input type="text" name="how_drink_drive_offence" class="form-control" style="width:50%" value="<?php echo $therapeutic['how_drink_drive_offence'] ?> " disabled></br>

        <label>Have you ever been in drug treatment before?</label></br>
        <input type="radio" name="drug_treat_before_ever" value="yes" <?php echo ($therapeutic['drug_treat_before_ever'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
        <input type="radio" name="drug_treat_before_ever" value="no" <?php echo ($therapeutic['drug_treat_before_ever'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
    </div>
<?php } ?>
...
<?php if ($therapeutic['being_referred_for_service'] == 'sex_behav') { ?>
    <div class="row" style="display:block" name="sex_behav_div">
        ...
        <input type="radio" name="sex_active" value="yes" <?php echo ($therapeutic['sex_active'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
        <input type="radio" name="sex_active" value="no" <?php echo ($therapeutic['sex_active'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
        ...
        <input type="radio" name="satisfied_sex_identity" value="yes" <?php echo ($therapeutic['satisfied_sex_identity'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
        <input type="radio" name="satisfied_sex_identity" value="no" <?php echo ($therapeutic['satisfied_sex_identity'] == 'no') ?  "checked" : ""; ?> disabled> No</br>

        <label>Have you ever been charged with a sex crime?</label><span style="color:red">*</span></br>
        <input type="radio" name="charged_sex_crime" value="yes" <?php echo ($therapeutic['charged_sex_crime'] == 'yes') ?  "checked" : ""; ?> disabled> Yes</br>
        <input type="radio" name="charged_sex_crime" value="no" <?php echo ($therapeutic['charged_sex_crime'] == 'no') ?  "checked" : ""; ?> disabled> No</br>
...
<?php if ($therapeutic['being_referred_for_service'] == 'domestic_violence') { ?>
    <div class="row" style="display:block" name="domestic_violence_div"></br>
        ...
        <label>Were you ever in a physical confrontation or fight?<span style="color:red"> * </span></label></br>
        <input type="radio" name="phy_confrintation" value="yes" <?php echo ($therapeutic['phy_confrintation'] == 'yes') ?  "checked" : ""; ?> disabled> Yes </br>
        <input type="radio" name="phy_confrintation" value="no" <?php echo ($therapeutic['phy_confrintation'] == 'no') ?  "checked" : ""; ?> disabled> No </br>

        <label>Have you ever physically hurt or injured someone?<span style="color:red"> * </span></label></br>
        <input type="radio" name="phy_hurt" value="yes" <?php echo ($therapeutic['phy_hurt'] == 'yes') ?  "checked" : ""; ?> disabled> Yes </br>
        <input type="radio" name="phy_hurt" value="no" <?php echo ($therapeutic['phy_hurt'] == 'no') ?  "checked" : ""; ?> disabled> No </br>

        <label>Were you ever arrested for a violent crime?<span style="color:red"> * </span></label></br>
        <input type="radio" name="ever_arrested_violent_crime" value="yes" <?php echo ($therapeutic['ever_arrested_violent_crime'] == 'yes') ?  "checked" : ""; ?> disabled> Yes </br>
        <input type="radio" name="ever_arrested_violent_crime" value="no" <?php echo ($therapeutic['ever_arrested_violent_crime'] == 'no') ?  "checked" : ""; ?> disabled> No </br>
...
<?php if ($therapeutic['Intake_suicide'] == 'attemptedsuicide') { ?>
    ...
    <div class="row" style="display:block" name="felt_inclined_div">
        ...
        <div class="radio">
            <label>
                <input type="radio" name="felt_inclined_harm" value="today" <?php echo ($therapeutic['felt_inclined_harm'] == 'today') ?  "checked" : ""; ?> disabled> Today
            </label>
        </div>
        <div class="radio">
            <label>
                <input type="radio" name="felt_inclined_harm" value="past_2_weeks" <?php echo ($therapeutic['felt_inclined_harm'] == 'past_2_weeks') ?  "checked" : ""; ?> disabled> Within the past 2 weeks
            </label>
        </div>
        <div class="radio">
            <label>
                <input type="radio" name="felt_inclined_harm" value="past_12_month" <?php echo ($therapeutic['felt_inclined_harm'] == 'past_12_month') ?  "checked" : ""; ?> disabled> Within the past 12 months
            </label>
        </div>
    </div>
<?php } ?>

<?php if ($therapeutic['Intake_suicide'] == 'suicidalthoughts') { ?>
    <div class="row" style="display:block" name="felt_inclined_div">
        <label>When was the last time you felt inclined to harm yourself?<span style="color:red"> * </span></label></br>
        <div class="radio">
            <label>
    ...
    <div class="row" style="display:block" name="feelings_explanation_div">
...
<div class="row">
    ...
    <div class="radio">
        <label>
            <input type="radio" name="arrested_ever" value="yes" <?php echo ($therapeutic['arrested_ever'] == 'yes') ?  "checked" : ""; ?> disabled> Yes
        </label>
    </div>
    <div class="radio">
        <label>
            <input type="radio" name="arrested_ever" value="no" <?php echo ($therapeutic['arrested_ever'] == 'no') ?  "checked" : ""; ?> disabled> No
        </label>
    </div>
</div>
...
<?php if ($therapeutic['how_many_arrest'] != '') { ?>
    <div class="row" style="display:block" name="arrested_explanation_div">
    ...
    <div class="row" style="display:block" name="monitoring_agency_div">
        ...
        <div class="radio">
            <label>
                <input type="radio" name="monitor_agency" value="yes" <?php echo ($therapeutic['monitor_agency'] == 'yes') ?  "checked" : ""; ?> disabled> Yes
            </label>
        </div>
        <div class="radio">
            <label>
                <input type="radio" name="monitor_agency" value="no" <?php echo ($therapeutic['monitor_agency'] == 'no') ?  "checked" : ""; ?> disabled> No
            </label>
        </div>
    </div>
    ...
    <div class="row" style="display:block" name="incarceration_div">
        <label>Have you ever been incarcerated?<span style="color:red"> * </span></label></br>
        <div class="radio">
            <label>
                <input type="radio" name="incarcerated" value="yes" <?php echo ($therapeutic['incarcerated'] == 'yes') ?  "checked" : ""; ?> disabled> Yes
            </label>
        </div>
        <div class="radio">
            <label>
                <input type="radio" name="incarcerated" value="no" <?php echo ($therapeutic['incarcerated'] == 'no') ?  "checked" : ""; ?> disabled> No
            </label>
        </div>
    </div>
    ...
    <div class="row" style="display:block" name="protection_orders_div">
        <label>Are there any orders of protection against you?<span style="color:red"> * </span></label></br>
        <div class="radio">
            <label>
                <input type="radio" name="protection_orders" value="yes" <?php echo ($therapeutic['protection_orders'] == 'yes') ?  "checked" : ""; ?> disabled> Yes
            </label>
        </div>
        <div class="radio">
            <label>
                <input type="radio" name="protection_orders" value="no" <?php echo ($therapeutic['protection_orders'] == 'no') ?  "checked" : ""; ?> disabled> No
            </label>
        </div>
    </div>

    <div class="row" style="display:block" name="state_registry_div">
        <label>Are you listed on any state registry?<span style="color:red"> * </span></label></br>
        <div class="radio">
            <label>
                <input type="radio" name="state_registry" value="yes" <?php echo ($therapeutic['state_registry'] == 'yes') ?  "checked" : ""; ?> disabled> Yes
            </label>
        </div>
        <div class="radio">
            <label>
                <input type="radio" name="state_registry" value="no" <?php echo ($therapeutic['state_registry'] == 'no') ?  "checked" : ""; ?> disabled> No
            </label>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="radio">
        <label>
            <input type="radio" name="exp_ver_phy_abuse" value="yes" <?php echo ($therapeutic['exp_ver_phy_abuse'] == 'yes') ?  "checked" : ""; ?> disabled> Yes
        </label>
    </div>
    <div class="radio">
        <label>
            <input type="radio" name="exp_ver_phy_abuse" value="no" <?php echo ($therapeutic['exp_ver_phy_abuse'] == 'no') ?  "checked" : ""; ?> disabled> No
        </label>
    </div>
</div>
...
<?php if ($therapeutic['exp_ver_phy_abuse'] == 'yes') { ?>
    <div class="row" style="display:block" name="victimDiv">
        ...
        <textarea class="form-control" name="explain_victim" disabled><?php echo $therapeutic['explain_victim'] ?></textarea>
    </div>
<?php } ?>
...
<div class="row">
    ...
    <div class="radio">
        <label>
            <input type="radio" name="mental_health_treat" value="yes" <?php echo ($therapeutic['mental_health_treat'] == 'yes') ?  "checked" : ""; ?> disabled> Yes
        </label>
    </div>
    <div class="radio">
        <label>
            <input type="radio" name="mental_health_treat" value="no" <?php echo ($therapeutic['mental_health_treat'] == 'no') ?  "checked" : ""; ?> disabled> No
        </label>
    </div>
</div>
...
<?php if ($therapeutic['mental_health_treat'] == 'yes') { ?>
    <div class="row" style="display:block" name="mentalHealthYesDiv">
        ...
        <div class="checkbox">
            <label>
                <input type="checkbox" name="mentalHealthTreatment[]" value="inpatient" <?php echo ($therapeutic['mentalHealthTreatment'] == 'inpatient') ?  "selected" : ""; ?> disabled> Inpatient
            </label>
        </div>
        <div class="checkbox">
            <label>
                <input type="checkbox" name="mentalHealthTreatment[]" value="outpatient" <?php echo ($therapeutic['mentalHealthTreatment'] == 'outpatient') ?  "selected" : ""; ?> disabled> Outpatient
            </label>
        </div>
        <div class="checkbox">
            <label>
                <input type="checkbox" name="mentalHealthTreatment[]" value="partialHospitaliation" <?php echo ($therapeutic['mentalHealthTreatment'] == 'partialHospitaliation') ?  "selected" : ""; ?> disabled> Partial hospitalization
            </label>
        </div>
        <div class="checkbox">
            <label>
                <input type="checkbox" name="mentalHealthTreatment[]" value="dayTreatment" <?php echo ($therapeutic['mentalHealthTreatment'] == 'dayTreatment') ?  "selected" : ""; ?> disabled> Day treatment
            </label>
        </div>
    </div>
<?php } ?>
...
<?php if ($therapeutic['mentalHealthTreatment'] == 'inpatient') { ?>
    <div class="row" style="display:block" name="inPatientDiv">
        ...
        <textarea class="form-control" name="inpatient_treatment_consist" disabled><?php echo $therapeutic['inpatient_treatment_consist'] ?></textarea></br>
    </div>
<?php } ?>
<?php if ($therapeutic['mentalHealthTreatment'] == 'outpatient') { ?>
    <div class="row" style="display:block" name="outPatientDiv">
        ...
        <input type="text" class="form-control datepicker" name="date_treat_outputpatient" style="width:50%" value="<?php echo $therapeutic['date_treat_outputpatient'] ?>" disabled></br>

        <label>What type of outpatient treatment did you receive?</label></br>
        <div class="checkbox">
            <label>
                <input type="checkbox" name="outpatient_treatment[]" value="Psychotherapy" <?php echo ($therapeutic['outpatient_treatment'] == 'Psychotherapy') ?  "selected" : ""; ?> disabled> Psychotherapy
            </label>
        </div>
        <div class="checkbox">
            <label>
                <input type="checkbox" name="outpatient_treatment[]" value="family_therapy" <?php echo ($therapeutic['outpatient_treatment'] == 'family_therapy') ?  "selected" : ""; ?> disabled> Family Therapy
            </label>
        </div>
        <div class="checkbox">
            <label>
                <input type="checkbox" name="outpatient_treatment[]" value="medication" <?php echo ($therapeutic['outpatient_treatment'] == 'medication') ?  "selected" : ""; ?> disabled> Medication
            </label>
        </div>
        <div class="checkbox">
            <label>
                <input type="checkbox" name="outpatient_treatment[]" value="other" <?php echo ($therapeutic['outpatient_treatment'] == 'other') ?  "selected" : ""; ?> disabled> Other
            </label>
        </div>
        <label>Who was your outpatient therapist/doctor?</label></br>
        <input type="text" value="" name="therapist_doc" class="form-control" style="width:50%" value="<?php echo $therapeutic['therapist_doc'] ?>" disabled></br>
        ...
        <textarea class="form-control" name="prescribed_medication" disabled><?php echo $therapeutic['prescribed_medication'] ?></textarea>
    </div>
<?php } ?>
...
<?php if ($therapeutic['mentalHealthTreatment'] == 'partialHospitaliation') { ?>
    <div class="row" style="display:block" name="partialHospitalDiv">
        ...
        <input type="text" class="form-control datepicker" name="name_pgm_last_treat" style="width:50%" value="<?php echo $therapeutic['name_pgm_last_treat'] ?>" disabled></br>
    </div>
<?php } ?>
...
<?php if ($therapeutic['mentalHealthTreatment'] == 'dayTreatment') { ?>
    <div class="row" style="display:block" name="dayTreatmentDiv">
        ...
        <input type="text" class="form-control datepicker" name="day_treat_name" style="width:50%" value="<?php echo $therapeutic['day_treat_name'] ?>" disabled></br>
    </div>
<?php } ?>
...
<?php if ($therapeutic['mental_health_treat'] == 'no') { ?>
    <div class="row" style="display:block" name="mentalHealthNoDiv">
        ...
        <textarea name="explain_primary_mentalHealth" class="form-control" disabled><?php echo $therapeutic['explain_primary_mentalHealth'] ?></textarea>
    </div>
<?php } ?>