            ...
            <div class="row">
              ...
              <div class="col-md-4 text mb-2" id="templateDD">
                <select class="form-control form-control-sm" name="template" id="template" onchange="TemplateSentence(this.value)">
                    ...
                    <?php
                    $resTemplates = sqlStatement("SELECT * FROM customlists AS c WHERE c.cl_list_type=3 AND c.cl_list_id=? AND c.cl_deleted=0 ORDER BY c.cl_list_item_long", array($rowContext['cl_list_id'] ?? null));
