...
require_once dirname(__FILE__, 2) . '/../../interface/main/calendar/zoom_functions.php';
            ...
            <div id="main-component" class="col-md-8 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <?php } ?>
                      <?php }
                            echo enableVideoButton('group', $groupData['group_id']) . " " . $groupData['group_id']; //This should display the button like in the patient dashboard
                        ?>
                    </div>
                </div>
                <div class="row">
